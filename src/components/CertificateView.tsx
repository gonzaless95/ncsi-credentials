  ...
  *,
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      // Use the actual canvas dimensions to ensure it fills the page perfectly
      // We convert from pixels to points (1 px = 0.75 pt)
            ...
            <div className="relative group">
              ...
              {hasDesign && (
                <div
                  ...
                  style={{ width: designConfig.canvas.width }}
                >
                  <CertificateRenderer
                    ref={stageRef}
                    canvas={designConfig.canvas}
